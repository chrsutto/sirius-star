...
function getManualYieldData() {
  return [
    ...
    // Spark Protocol (Sky Star)
    {
      protocol: 'Spark Savings USDC',
      stablecoin: 'USDC',
      chain: 'Multi-chain',
      apy: 4.25,
      tvl: 1200000000,
      type: 'Savings',
      source: 'spark',
      description: 'Earn Sky Savings Rate on USDC - Sky Star protocol',
      url: 'https://app.spark.fi/savings',
      updatedAt: new Date().toISOString()
    },
    {
      protocol: 'Spark Savings sUSDS',
      stablecoin: 'USDS',
      chain: 'Multi-chain',
      apy: 4.5,
      tvl: 800000000,
      type: 'Savings',
      source: 'spark',
      description: 'Yield-bearing USDS token via Sky Savings Rate',
      url: 'https://app.spark.fi/savings',
      updatedAt: new Date().toISOString()
    },
    {
      protocol: 'Spark Savings USDT',
      stablecoin: 'USDT',
      chain: 'Multi-chain',
      apy: 4.5,
      tvl: 600000000,
      type: 'Savings',
      source: 'spark',
      description: 'Earn Sky Savings Rate on USDT',
      url: 'https://app.spark.fi/savings',
      updatedAt: new Date().toISOString()
    },
    {
      protocol: 'SparkLend USDC',
      stablecoin: 'USDC',
      chain: 'Multi-chain',
      apy: 3.2,
      tvl: 450000000,
      type: 'Lending',
      source: 'spark',
      description: 'Supply USDC to SparkLend money market - variable rate',
      url: 'https://app.spark.fi/markets',
      updatedAt: new Date().toISOString()
    },
    {
      protocol: 'SparkLend DAI',
      stablecoin: 'DAI',
      chain: 'Ethereum',
      apy: 2.8,
      tvl: 380000000,
      type: 'Lending',
      source: 'spark',
      description: 'Supply DAI to SparkLend money market - variable rate',
      url: 'https://app.spark.fi/markets',
      updatedAt: new Date().toISOString()
    },
    {
      protocol: 'SparkLend USDS',
      stablecoin: 'USDS',
      chain: 'Multi-chain',
      apy: 3.5,
      tvl: 320000000,
      type: 'Lending',
      source: 'spark',
      description: 'Supply USDS to SparkLend money market - variable rate',
      url: 'https://app.spark.fi/markets',
      updatedAt: new Date().toISOString()
    },
    {
      protocol: 'SparkLend USDT',
      stablecoin: 'USDT',
      chain: 'Multi-chain',
      apy: 3.1,
      tvl: 280000000,
      type: 'Lending',
      source: 'spark',
      description: 'Supply USDT to SparkLend money market - variable rate',
      url: 'https://app.spark.fi/markets',
      updatedAt: new Date().toISOString()
    },
    {
      protocol: 'SparkLend PYUSD',
      stablecoin: 'PYUSD',
      chain: 'Ethereum',
      apy: 2.8,
      tvl: 135000000,
      type: 'Lending',
      source: 'spark',
      description: 'Supply PayPal USD to SparkLend money market - variable rate',
      url: 'https://app.spark.fi/markets',
      updatedAt: new Date().toISOString()
    },
    
    // Grove Finance (Institutional Infrastructure)
    {
      protocol: 'Grove Allocator - JAAA',
      stablecoin: 'USDC',
      chain: 'Ethereum',
      apy: 5.3,
      tvl: 1100000000,
      type: 'Institutional',
      source: 'grove',
      description: '⚠️ Institutional Only - Janus Henderson AAA CLO strategy. Not retail-accessible. Yields flow to Sky Savings Rate.',
      url: 'https://www.grove.finance/products',
      updatedAt: new Date().toISOString()
    },
    {
      protocol: 'Grove Allocator - BUIDL',
      stablecoin: 'USDC',
      chain: 'Ethereum',
      apy: 5.0,
      tvl: 100000,
      type: 'Institutional',
      source: 'grove',
      description: '⚠️ Institutional Only - BlackRock Treasury tokenized fund. Not retail-accessible.',
      url: 'https://www.grove.finance/products',
      updatedAt: new Date().toISOString()
    },
